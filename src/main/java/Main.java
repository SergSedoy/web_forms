...
//                    if (!path.equals("/"))
    ...
    //парсим query параметры и их значения
    private static void getQueryParam(String path) {
        ...
        for (int i = 0; i < listQueryParam.size(); i++) {
            System.out.println(listQueryParam.get(i) + " - " + listQueryValue.get(i));
        }
    }
